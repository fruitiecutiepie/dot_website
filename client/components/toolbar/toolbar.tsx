...
export function CarbonSlash(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="currentColor" stroke="currentColor" {...props}>
      <path d="M 8 28 L 28 8" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
    </svg>
  )
}
...
class Toolbar extends React.Component<IToolbarProps, any> {
  ...
  constructor(props: any) {
    ...
    this.handlePinnedUrl = this.handlePinnedUrl.bind(this)
    ...
    return (
      <div className="toolbar">
        <div className="inner">
          ...
          />
          {this.props.pinnedUrl && <button
            className={`${this.props.pinnedUrl ? 'pinned' : ''}`}
            title="Back to pinned URL"
            onClick={this.handlePinnedUrl}
          >
            <CarbonSlash />
          </button>}
          <button
  ...
  private handlePinnedUrl() {
    this.props.onActionInvoked('pinnedUrl', {})
  }
